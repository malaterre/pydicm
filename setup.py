...
# hint:
# https://github.com/essembeh/python-helloworld
...
class CMakeExtension(Extension):
    def __init__(self, name: str, sourcedir: str = "") -> None:
        ...
        self.sourcedir = os.fspath((Path(sourcedir) / "libdicm").resolve())
...
setup(
    ...
    description="python-libdicm",
    long_description="",
    ext_modules=[CMakeExtension("libdicm")],
